<?php
class LoaiSlideController extends Controller {
    ...
    public function create() {
        ...
        view('backend.index', [
            'view' => 'backend.loai_slide.create',
        ]);
    }
    ...
    public function insert() {
        ...
        Validation::validate(Request::all(), [
            'ten' => 'required|unique:loai_slide',
        ])->execute();
    ...
    public function update($id) {
        ...
        Validation::validate(Request::all(), [
            'ten' => "required|unique:loai_slide,ten,$id",
        ])->execute();
