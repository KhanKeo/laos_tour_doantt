...
class TaiKhoanAdminController extends Controller {
    ...
    public function index() {
        ...
        $results = $this->model()->where('loai', 1);
        if ($search != null) {
        ...
        view('backend.index', [
            'view' => 'backend.tai_khoan_admin.index',
            'results' => $results,
            'search' => $search
        ]);
    }
    ...
    public function create() {
        ...
        view('backend.index', [
            'view' => 'backend.tai_khoan_admin.create'
        ]);
    }
    ...
    public function insert() {
        ...
        Validation::validate(Request::all(), [
            ...
            'email' => 'required|unique:tai_khoan',
        ])->execute();
    ...
    public function edit($id) {
        ...
        view('backend.index', [
            'view' => 'backend.tai_khoan_admin.edit',
            'result' => $result
        ]);
    }
