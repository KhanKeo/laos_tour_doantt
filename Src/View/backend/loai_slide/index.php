...
<section class="page-cover page-cover-admin" id="cover-tour-grid-list">
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-title">Quản lý loại slide</h1>
            <ul class="breadcrumb">
                <li><a href="/thongke/index">Trang chủ</a></li>
                <li class="active">Danh sách loại slide</li>
            </ul>
        </div><!-- end columns -->
    </div><!-- end row -->
</section>
...
<ul class="nav nav-tabs">
    <li role="presentation"><a href="/slide/index">Slide</a></li>
    <li role="presentation" class="active"><a>Loại slide</a></li>
</ul>
<br />
<!-- END OF USER TAB -->
