...
<section class="page-cover page-cover-admin" id="cover-tour-grid-list">
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-title">Quản lý loại trợ giúp</h1>
            <ul class="breadcrumb">
                <li><a href="/thongke/index">Trang chủ</a></li>
                <li class="active">Danh sách loại trợ giúp</li>
            </ul>
        </div><!-- end columns -->
    </div><!-- end row -->
</section>
...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a>Quản lý loại trợ giúp</a></li>
</ul>
<br />
<!-- END OF USER TAB -->
