...
<table class="table table-striped table-hover">
    <thead>
        <tr>
            ...
            <th>Ngày kết thúc</th>
            <th>Phương tiện</th>
            <th>Địa chỉ xuất phát</th>
            <th>Địa chỉ điểm đến</th>
            <th>Giá người lớn</th>
            <th>Giá trẻ em</th>
            <th>Ngày đăng</th>
        </tr>
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td><?= $cnt ?></td>
                <td><img src="<?= asset('images/tour/hinh' . $result['id'] . '.png') ?>" height="50px"></td>
                <td><?= $result['ten'] ?></td>
                <td><?= $result['so_nguoi'] ?></td>
                <td><?= $result['ngay_khoi_hanh'] ?></td>
                <td><?= $result['ngay_ket_thuc'] ?></td>
                <td><?= $result['phuong_tien'] ?></td>
                <td><?= $result['dia_chi_xuat_phat'] ?></td>
                <td><?= $result['dia_chi_diem_den'] ?></td>
                <td><?= $result['gia_nguoi_lon'] ?></td>
                <td><?= $result['gia_tre_em'] ?></td>
                <td><?= $result['ngay_dang'] ?></td>
                <td>
                    <div style="white-space: nowrap;">
                        <a href="/<?= $controller ?>/adminCopy/<?= $result['id'] ?>">
                            <button type="button" class="btn btn-warning btn-block" style="display:inline;width:auto;margin-left:10px;"><i class="fa fa-copy" aria-hidden="true"></i></button>
                        </a>
