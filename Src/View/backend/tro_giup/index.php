...
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a>Đang đợi trợ giúp</a></li>
    <li role="presentation"><a href="/trogiup/sent">Đã trợ giúp</a></li>
                ...
                <td>
                    <div>
                        <a href="/<?= $controller ?>/edit/<?= $result['id'] ?>">
                            <button type="button" class="btn btn-primary btn-block" style="display:inline;width:auto;margin-left:10px;">Trả lời</button>
                        </a>
