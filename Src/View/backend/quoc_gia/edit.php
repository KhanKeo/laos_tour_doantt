...
<div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="ten" id="ten" placeholder="Tên quốc gia" required value="<?= $result['ten'] ?>">
        </div>
    </div>
