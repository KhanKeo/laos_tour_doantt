...
<section class="page-cover page-cover-admin" id="cover-tour-grid-list">
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-title">Quản lý slide</h1>
            <ul class="breadcrumb">
...
<ul class="nav nav-tabs">
    <li role="presentation" class="active"><a href="#">Slide</a></li>
    <li role="presentation"><a href="/loaislide/index">Loại slide</a></li>
</ul>
<br />
<!-- END OF USER TAB -->
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?= $result['loai_slide'] ?></td>
                <td><img src="<?= asset('images/slide/hinh' . $result['id'] . '.png') ?>" height="50px" ></td>
                <td><?= $result['tieu_de'] ?></td>
                <td><?= $result['noi_dung'] ?></td>
                <td><?= $result['ngay_bat_dau'] ? $result['ngay_bat_dau'] : 'Không' ?></td>
                <td><?= $result['ngay_ket_thuc'] ? $result['ngay_ket_thuc'] : 'Không' ?></td>
