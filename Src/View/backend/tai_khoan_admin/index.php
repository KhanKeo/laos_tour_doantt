...
<ul class="nav nav-tabs">
  ...
  <li role="presentation"><a href="/taikhoanquanly/index">Người quản lý</a></li>
...
<div class="mt-2">
    <div class="row">
        <div class="col-sm-6">
            <button class="btn btn-primary" onclick="location.href='/<?= $controller ?>/create'"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</button>
        </div>
        <div class="col-sm-6">
